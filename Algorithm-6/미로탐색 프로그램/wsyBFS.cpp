...
////
////void main() {
////	queue <Location2D> locQueue;	// 위치 덱 객체 생성
////	Location2D entry(1,0);	// 입구 객체
////	locQueue.push(entry);	// 덱에 입구 위치 삽입
////
////	while(locQueue.empty() == false) {	// 뎅이 비어있지 않는 동안
////		Location2D here = locQueue.front();	// 덱의 front 상단 객체 복사
